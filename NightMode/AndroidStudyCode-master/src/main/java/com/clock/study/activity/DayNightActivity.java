 ...
 * @since 2016-08-11
 */
public class DayNightActivity extends AppCompatActivity implements CompoundButton
    ...
    private void showAnimation() {
        ...
        if (decorView instanceof ViewGroup && cacheBitmap != null) {
            ...
            ViewGroup.LayoutParams layoutParam = new ViewGroup.LayoutParams(ViewGroup
